...
## Testing
- When changing or running tests, read `.crouter/memory/testing.md` first because Humanloop limits what warrants durable test coverage, uses focused local runs, and enforces per-script and whole-suite duration bounds.
